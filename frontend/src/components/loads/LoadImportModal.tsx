    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-[700px] max-h-[85vh] flex flex-col overflow-hidden">
            ...
            <div>
              <div className="flex gap-4 mb-4">
                <div className="flex-1 bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <p className="text-xs text-blue-600 font-semibold">Success</p>
                  <p className="text-2xl font-bold text-blue-700">{result.success}</p>
                </div>
        ...
        <div className="flex justify-end gap-2 px-5 py-3 border-t border-gray-200 bg-gray-50">
          {result ? (
            <button onClick={onClose} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded font-semibold">
              Done
            </button>
          ) : (
            <>
              ...
              <button onClick={handleImport} disabled={!file || uploading}
                className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded font-semibold disabled:opacity-50">
